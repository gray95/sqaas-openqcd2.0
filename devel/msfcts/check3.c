...
static void read_wflow_parms(void)
{
   ...
   error_root(ntm==0,1,"read_wflow_parms [check3.c]",
              "No flow times specified");
   error_root(eps<=0.0,1,"read_wflow_parms [check3.c]",
   ...
   error(tms==NULL,1,"read_wflow_parms [check3.c]",
   ...
   if (my_rank==0)
   {
      ...
      error_root(ie!=0,1,"read_wflow_parms [check3.c]","Flow times must be "
